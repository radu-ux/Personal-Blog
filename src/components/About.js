            ...
            <div className="flex flex-col py-20 md:grid md:grid-rows-2 md:mt-10">
                <div className="flex flex-col mb-16 md:grid md:grid-cols-3">
                    <div className="mb-8 px-5 md:col-span-2 text-xl md:px-5">
                        ...
                        <span className="block mt-5 text-md">Visit Faculty Website <a href="#" className="text-purple-700 hover:text-purple-500 uppercase font-semibold">here</a></span>
                    </div>
                    <div className="px-5 mx-auto">
                        <img className="rounded-full w-64 h-64 md:w-44 md:h-44 lg:h-72 lg:w-72" src={FacultyImage}></img>
                    </div>
                </div>
                {/* Hobbies Section*/}
                <div className="flex flex-col md:grid md:grid-cols-3">
                    <div className="px-5 mx-auto order-2 md:order-1">
                        <div className="grid grid-cols-2">
                            <img className="rounded-full w-32 h-32 lg:w-44 lg:h-44" src={ReactImage}></img>
                            <img className="rounded-full w-32 h-32 lg:w-44 lg:h-44" src={BootstrapImage}></img>
                        </div>
                        <div className="grid grid-cols-2">
                            <img className="rounded-full col-span-2 mx-auto w-32 h-32 lg:w-44 lg:h-44" src={TailwindCSSImage}></img>
                        </div>
                    </div>
                ...
                <div className="flex flex-col mt-16 md:grid md:grid-cols-3">
                    <div className="mb-8 px-5 text-xl md:py-10 md:col-span-2 md:px-5 xl:py-20">
                        ...
                        moment I can see my life without this activity. Apart from going to gym, I also like play football
                        with my friends and bike riding. Hanging auto is a clear option when it comes to spending free time.
                    </div>
                    <div className="px-5 mx-auto">
                        <div className="grid grid-cols-2">
                            <img className="rounded-full object-cover object-center w-44 h-44 md:w-32 md:h-32 xl:w-56 xl:h-56" src={BikeRidingImage}></img>
                        </div>
                        <div className="grid grid-cols-3">
                            <div></div>
                            <img className="rounded-full col-span-2 mx-auto object-cover object-center w-44 h-44 md:w-32 md:h-32 xl:w-56 xl:h-56" src={FootballImage}></img>
                        </div>
                    </div>
                </div>
            </div>
